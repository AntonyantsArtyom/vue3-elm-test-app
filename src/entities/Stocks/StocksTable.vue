...
<template>
  <el-table class="stocks-table" :data="stocks" :table-layout="'auto'">
    ...
    <el-table-column prop="in_way_from_client" label="В&nbsp;пути&nbsp;от&nbsp;клиента" />
    ...
    <el-table-column prop="sc_code" label="SC&nbsp;Code" />
